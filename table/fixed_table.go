...
// 			default:
// 				lineRuneSlice[index] = rune(t.calculateCellContentRune(0, 0, colRelativeIndex%(t.CellWidth+1)-1))
// 			}
// 		}
// 	}
...
// func (t FixedTable) calculateTableWidth() int {
// 	return t.CellWidth*t.Col + tab.Width()*(t.Col+1) + 1
// }

// func (t FixedTable) calculateTableHeight() int {
// 	return t.CellHeight*t.Row + tab.Width()*(t.Row+1)
// }

// func (t FixedTable) calculateCellWidthEndIndex(int) (int, int, int) {
// 	return 0
// }

// func (t FixedTable) calculateCellHeightEndIndex(int) (int, int, int) {
// 	return 0
// }

// func (t FixedTable) calculateCellContentRune(int, int, contentIndex int) rune {
